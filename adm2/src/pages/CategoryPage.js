  ...
  return (
    <>
      ...
      <Container>
        ...
        <CategoryCreationModal open={openCreationModal} onClose={() => setOpenCreationModal(false)} onCreate={() => fetchCategories()} />
        <Card>
          
          {
            isFetching ? <Grid container alignItems="center"
                ...
                <Table>
                  ...
                  <TableBody>
                    {categories.length && categories.map((row) => {
                      const { id, name, localization } = row;
                        ...
                        <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                          ...
                          <TableCell align="center">
                            {localization.map((locale) => {
                              return locale.language.code.toUpperCase()
                              // return emojiFlags[locale.language.code.toUpperCase()].emoji
                            }).join(', ') || '-'}
